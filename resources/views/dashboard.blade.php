    ...
    <div class="card shadow-sm border-0 mb-4" style="background-color: #FDF2F8;">
        <div class="card-body p-4">
            ...
            <p class="card-text text-muted mt-2">
                Ini adalah sistem informasi terintegrasi yang digunakan untuk mengelola dan mengotomatisasi berbagai proses bisnis dalam Bokor Mas Gold, mulai dari keuangan, sumber daya manusia, rantai pasokan, hingga produksi.
            </p>
        </div>
    </div>
    
    <div class="row g-4">
        {{-- Panel Ringkasan Penjualan per Cabang --}}
        <div class="col-lg-12">
