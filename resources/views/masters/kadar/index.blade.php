        ...
        <div class="container">
            ...
            <div class="card shadow-sm border-0">
                <div class="card-header bg-custom-pink text-dark d-flex justify-content-between align-items-center">
                    ...
                    {{-- **FIX:** Changed route to 'master.kadar.create' --}}
                    <a href="{{ route('master.kadar.create') }}" class="btn btn-dark">
                            ...
                            <tbody>
                                @forelse ($kadars as $index => $kadar)
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            {{-- **FIX:** Changed routes to use the 'master.' prefix --}}
                                            <a href="{{ route('master.kadar.edit', $kadar->id) }}" class="btn btn-sm btn-secondary">
                                                <i class="bi bi-pencil-fill"></i> Edit
                                            </a>
                                            <form action="{{ route('master.kadar.destroy', $kadar->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data ini?');">
                                                @csrf
                                                @method('DELETE')
